...
TITLE AFTER-FORMAT TOOL

start http://www.motospeed.cc/upfile/download/MotoSpeed_GamingMouse_V30(20180627).rar
start https://github.com/Sycnex/Windows10Debloater/archive/master.zip
start https://d38w655bqoyvyi.cloudfront.net/manager/SteamGridDB+Manager+Setup+0.4.2.exe
start https://www.ccleaner.com/speccy/download/standard
...
start https://github.com/Nexus-Mods/Nexus-Mod-Manager/releases/download/0.71.2/Nexus.Mod.Manager-0.71.2.exe
...
start https://ninite.com/classicstart-discord-firefox-irfanview-notepadplusplus-qbittorrent-realvnc-steam-vlc-vscode-winrar/ninite.exe
